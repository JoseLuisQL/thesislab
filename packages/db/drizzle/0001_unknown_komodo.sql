...
--> statement-breakpoint
CREATE UNIQUE INDEX `claim_evidence_links_unique_idx` ON `claim_evidence_links` (`claim_id`,`evidence_fragment_id`);--> statement-breakpoint
CREATE TABLE `claims` (
	`id` text PRIMARY KEY NOT NULL,
	`thesis_id` text NOT NULL,
	`normalized_node_id` text,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `theses_slug_idx` ON `theses` (`slug`);--> statement-breakpoint
